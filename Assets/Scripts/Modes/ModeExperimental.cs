...
public class ModeExperimental : IMode
{
    ...
    private void _TryGetNextLabelText()
    {
        ...
        _hitObject?.OnHoverAction((gameObject) =>
        {
            ...
            // TODO: DODA� SPRAWDZANIE CZY FAKTYCZNIE ZMIENIONO LABEL
            _SceneChangedHandler();
        });
    }
    ...
    private void _TryRemoveFocusedLabel()
    {
        _hitObject?.OnHoverAction((gameObject) =>
        {
            ...
            // TODO: DODA� SPRAWDZANIE CZY FAKTYCZNIE USUNI�TO LABEL
            _SceneChangedHandler();
        });
    }
    ...
    private void _TryAddLabel()
    {
        _hitObject?.OnHoverAction((gameObject) =>
        {
            ...
            // TODO: DODA� SPRAWDZANIE CZY FAKTYCZNIE DODANO LABEL
            _SceneChangedHandler();
        });
    }
    ...
    public void AddRadialMenu()
    {
        ...
        if (canvasPrefab != null)
        {
            ...
            if (radialMenuRoot != null)
            {
                ...
                {
                    Debug.LogError("Nie mo�na za�adowa� prefabrykatu MenuItem z Resources/RadialMenuItem");
                }
            }
            else
            {
    ...
    public void SetUpFlystick()
    {
        ...
        FlystickController.SetAction(
            ...
            () =>
            {
                if (_isRaycastLocked || !radialMenu.isMenuActive) return;
